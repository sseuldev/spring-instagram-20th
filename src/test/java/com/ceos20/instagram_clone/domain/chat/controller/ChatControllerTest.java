...
class ChatControllerTest {
    ...
    public void setUp() {
        ...
        Member sender = new Member("보내는애", "sender@naver", "ROLE_ADMIN",null, "0000", "보내는사람이야", "http://link.url", "", null, "", null);
        Member receiver1 = new Member("받는애", "receiver@naver", "ROLE_ADMIN",null, "1234", "받는사람이야", "http://link.url", "", null, "", null);
        Member receiver2 = new Member("받는애2", "receiver2@naver", "ROLE_ADMIN",null, "1234", "받는사람이야", "http://link.url", "", null, "", null);
